/********************************************************************************************************
   	Module		:  rmcr_63_backtest_data_export

   	Function	:  This macro will be used to create export package for backtest lib from 63 to 81.
	...
	Sample call :
					...
					%include "&m_source_code_path/rmcr_63_backtest_data_export.sas";
					%CSBINIT;
					%rmcr_63_backtest_data_export();
				   
*********************************************************************************************************/


	%macro rmcr_63_backtest_data_export();
		...
		proc printto log="&path_to_log/rmcr_63_backtest_data_export_&timestamp..log";     /* i18nOK:Line */
		run;
		...
		/****** Create backtest xpt at the solution data path -starts ******/
		proc cport lib=backtest file="&path_to_solution_data_xpt./backtest.xpt"; run;    /* i18nOK:Line */
		%let job_rc=&syscc;

		/****** Create xpts at the solution data path -ends ******/

	%mend rmcr_63_backtest_data_export;
