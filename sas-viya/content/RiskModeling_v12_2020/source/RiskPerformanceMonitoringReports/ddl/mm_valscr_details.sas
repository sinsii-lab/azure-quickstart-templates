...
attrib MEASURE_NM length=$400 label='Measure Name';
attrib MEASURE_VALUE length=8 label='Measure Value';
attrib VALIDATION_SCORE length=8 label='Validation Score';
