...
attrib NO_OF_EVENTS_ACTUAL length=8 label='No of Actual Events';
...
attrib EVENT_RATE length=8 label='Event Rate';
attrib ODDS length=8 label='Odds';
attrib LOG_OF_ODDS length=8 label='Log Odds';
