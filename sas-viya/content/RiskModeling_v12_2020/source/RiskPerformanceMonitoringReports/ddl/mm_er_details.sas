...
attrib ACTUAL length=$10 label='Actual';
attrib PREDICTED_NON_EVENT length=8 label='Predicted: Non-Event';
attrib PREDICTED_EVENT length=8 label='Predicted: Event';
attrib TOTAL length=8 label='Total';
