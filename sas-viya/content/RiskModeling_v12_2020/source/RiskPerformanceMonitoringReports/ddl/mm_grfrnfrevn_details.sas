...
attrib PROP_NON_EVENTS_FRAC length=8 label='Proportion of Non-Events';
attrib CUM_PROP_NEVENTS length=8 label='Fraction of Non-Events';
attrib CUM_PROP_EVENTS length=8 label='Fraction of Events';
