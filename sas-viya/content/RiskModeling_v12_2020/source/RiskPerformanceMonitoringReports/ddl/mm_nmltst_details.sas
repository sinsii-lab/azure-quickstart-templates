...
attrib ZCALC length=8 label='Statistic Value';
attrib TRAFFIC length=8 label='TRAFFIC';
attrib NCLOW length=8 label='Normal: NCLOW';
attrib NCHIGH length=8 label='Normal: NCHIGH';
attrib DIFF length=8 label='DIFF';
attrib STDEV length=8 label='Standard Deviation';
attrib SUMDIFF length=8 label='Sum of Difference';
